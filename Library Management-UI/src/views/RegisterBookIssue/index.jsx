...
import {Redirect} from 'react-router-dom';
 ...
 class RegisterBookIssue extends Component {
    constructor(props) {
        super(props);
  ...
  this.setState({userid:book.userid});
	...
	issuedate : timestamp
        ...
        var self = this;
        console.log(s);
        axios.post("http://localhost/registerbookissue", s,{
          headers: 
              {Authorization : sid},
          }
    ...
    .then((result) => {
      console.log(result.data);
            ...
            if(responseJson.message.successMessage ==="Book issued successfully")
           {
            toast.configure();
             // toast("Invalid Login !");
...
export default withStyles(styles)(RegisterBookIssue);
